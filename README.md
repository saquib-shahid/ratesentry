...
## 🔌 Example Usage (Integrating the Middleware)

This microservice exports an Express middleware that you can easily plug into *any* other application, given it shares the same Redis network.

```typescript
import express from 'express';
// 1. Import the middleware
import { rateLimiter } from 'rate-limiter-service/dist/middleware/rateLimiter.js'; 
...
It expects `process.env.REDIS_URL` to be present.
